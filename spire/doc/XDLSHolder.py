...
class XDLSHolder (SpireObject) :
    ...
    def ID(self)->int:
        ...
        ret = GetDllLibDoc().XDLSHolder_get_ID(self.Ptr)
        return ret
    ...
    def ID(self, value:int):
        ...
        GetDllLibDoc().XDLSHolder_set_ID(self.Ptr, value)
    ...
    def Cleared(self)->bool:
        ...
        ret = GetDllLibDoc().XDLSHolder_get_Cleared(self.Ptr)
        return ret
    ...
    def Cleared(self, value:bool):
        ...
        GetDllLibDoc().XDLSHolder_set_Cleared(self.Ptr, value)
    ...
    def EnableID(self)->bool:
        ...
        ret = GetDllLibDoc().XDLSHolder_get_EnableID(self.Ptr)
        return ret
    ...
    def EnableID(self, value:bool):
        ...
        GetDllLibDoc().XDLSHolder_set_EnableID(self.Ptr, value)
    ...
    def SkipMe(self)->bool:
        ...
        ret = GetDllLibDoc().XDLSHolder_get_SkipMe(self.Ptr)
        return ret
    ...
    def SkipMe(self, value:bool):
        ...
        GetDllLibDoc().XDLSHolder_set_SkipMe(self.Ptr, value)
    ...
    def Dispose(self):
        ...
        GetDllLibDoc().XDLSHolder_Dispose(self.Ptr)
    ...
    def AddElement(self ,tagName:str,value:'SpireObject'):
        ...
        GetDllLibDoc().XDLSHolder_AddElement(self.Ptr, tagNamePtr,intPtrvalue)
    ...
    def AddRefElement(self ,tagName:str,value:'SpireObject'):
        ...
        GetDllLibDoc().XDLSHolder_AddRefElement(self.Ptr, tagNamePtr,intPtrvalue)
    ...
    def WriteHolder(self ,writer:'IXDLSContentWriter'):
        ...
        GetDllLibDoc().XDLSHolder_WriteHolder(self.Ptr, intPtrwriter)
    ...
    def ReadHolder(self ,reader:'IXDLSContentReader')->bool:
        ...
        ret = GetDllLibDoc().XDLSHolder_ReadHolder(self.Ptr, intPtrreader)
        return ret
    ...
    def AfterDeserialization(self ,owner:'IDocumentSerializable'):
        ...
        GetDllLibDoc().XDLSHolder_AfterDeserialization(self.Ptr, intPtrowner)
    ...
    def BeforeSerialization(self):
        ...
        GetDllLibDoc().XDLSHolder_BeforeSerialization(self.Ptr)

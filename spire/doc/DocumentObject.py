...
class DocumentObject(DocumentSerializable, IDocumentObject):
    ...
    def ChildObjects(self) -> 'DocumentObjectCollection':
        ...
        intPtr = GetDllLibDoc().DocumentObject_get_ChildObjects(self.Ptr)
    ...
    def DocumentObjectType(self) -> 'DocumentObjectType':
        ...
        ret = GetDllLibDoc().DocumentObject_get_DocumentObjectType(self.Ptr)
    ...
    def Owner(self) -> 'DocumentObject':
        ...
        intPtr = GetDllLibDoc().DocumentObject_get_Owner(self.Ptr)
    ...
    def PreviousSibling(self) -> 'IDocumentObject':
        ...
        intPtr = GetDllLibDoc().DocumentObject_get_PreviousSibling(self.Ptr)
        ret = None if intPtr==None else self._createDocumentObject(intPtr)
        return ret
    ...
    def NextSibling(self) -> 'IDocumentObject':
        ...
        intPtr = GetDllLibDoc().DocumentObject_get_NextSibling(self.Ptr)
        ret = None if intPtr==None else self._createDocumentObject(intPtr)
        return ret
    ...
    def IsComposite(self) -> bool:
        ...
        ret = GetDllLibDoc().DocumentObject_get_IsComposite(self.Ptr)
        return ret
    ...
    def FirstChild(self) -> 'DocumentObject':
        ...
        intPtr = GetDllLibDoc().DocumentObject_get_FirstChild(self.Ptr)
        ret = None if intPtr==None else self._createDocumentObject(intPtr)
        return ret
    ...
    def LastChild(self)->'DocumentObject':
        ...
        intPtr = GetDllLibDoc().DocumentObject_get_LastChild(self.Ptr)
        ret = None if intPtr==None else self._createDocumentObject(intPtr)
        return ret
    ...
    def Clone(self) -> 'DocumentObject':
        ...
        intPtr = GetDllLibDoc().DocumentObject_Clone(self.Ptr)
        ret = None if intPtr==None else self._createDocumentObject(intPtr)
        return ret
    ...
    def ToString(self ,seperator:str)->str:
        ...
        ret = PtrToStr(GetDllLibDoc().DocumentObject_ToString(self.Ptr, seperatorPtr))
        return ret
    ...
    def GetPreviousWidgetSibling(self)->'IDocumentObject':
        ...
        intPtr = GetDllLibDoc().DocumentObject_GetPreviousWidgetSibling(self.Ptr)
    ...
    def GetNextWidgetSibling(self)->'IDocumentObject':
        ...
        intPtr = GetDllLibDoc().DocumentObject_GetNextWidgetSibling(self.Ptr)
        ret = None if intPtr==None else IDocumentObject(intPtr)
        return ret
    ...
    def PrependChild(self ,newChild:'DocumentObject')->'DocumentObject':
        ...
        intPtr = GetDllLibDoc().DocumentObject_PrependChild(self.Ptr, intPtrnewChild)

...
class RectangleF (SpireObject) :
    ...
    def __init__(self, x:float, y:float, width:float, height:float):
        ...
        intPtr = dlllib.RectangleF_CreateXYWH(x, y, width, height)
    ...
    def __init__(self, location:PointF,size:SizeF):
        ...
        intPtr = dlllib.RectangleF_CreateLS(ptrPoint,ptrSize)
        super(RectangleF, self).__init__(intPtr)
    """
    ...
    def ToString(self)->str:
        ...
        ret = PtrToStr(dlllib.RectangleF_ToString(self.Ptr))
        return ret

...
class TablePositioning (  AttrCollection) :
    ...
    def HorizPositionAbs(self)->'HorizontalPosition':
        ...
        ret = GetDllLibDoc().TablePositioning_get_HorizPositionAbs(self.Ptr)
    ...
    def HorizPositionAbs(self, value:'HorizontalPosition'):
        ...
        GetDllLibDoc().TablePositioning_set_HorizPositionAbs(self.Ptr, value.value)
    ...
    def VertPositionAbs(self)->'VerticalPosition':
        ...
        ret = GetDllLibDoc().TablePositioning_get_VertPositionAbs(self.Ptr)
    ...
    def VertPositionAbs(self, value:'VerticalPosition'):
        ...
        GetDllLibDoc().TablePositioning_set_VertPositionAbs(self.Ptr, value.value)
    ...
    def HorizPosition(self)->float:
        ...
        ret = GetDllLibDoc().TablePositioning_get_HorizPosition(self.Ptr)
        return ret
    ...
    def HorizPosition(self, value:float):
        ...
        GetDllLibDoc().TablePositioning_set_HorizPosition(self.Ptr, value)
    ...
    def VertPosition(self)->float:
        ...
        ret = GetDllLibDoc().TablePositioning_get_VertPosition(self.Ptr)
        return ret

    @VertPosition.setter
    def VertPosition(self, value:float):
        GetDllLibDoc().TablePositioning_set_VertPosition.argtypes=[c_void_p, c_float]
        GetDllLibDoc().TablePositioning_set_VertPosition(self.Ptr, value)
    ...
    def HorizRelationTo(self)->'HorizontalRelation':
        ...
        ret = GetDllLibDoc().TablePositioning_get_HorizRelationTo(self.Ptr)
    ...
    def HorizRelationTo(self, value:'HorizontalRelation'):
        ...
        GetDllLibDoc().TablePositioning_set_HorizRelationTo(self.Ptr, value.value)
    ...
    def VertRelationTo(self)->'VerticalRelation':
        ...
        ret = GetDllLibDoc().TablePositioning_get_VertRelationTo(self.Ptr)
    ...
    def VertRelationTo(self, value:'VerticalRelation'):
        ...
        GetDllLibDoc().TablePositioning_set_VertRelationTo(self.Ptr, value.value)
    ...
    def DistanceFromTop(self)->float:
        ...
        ret = GetDllLibDoc().TablePositioning_get_DistanceFromTop(self.Ptr)
        return ret
    ...
    def DistanceFromTop(self, value:float):
        ...
        GetDllLibDoc().TablePositioning_set_DistanceFromTop(self.Ptr, value)
    ...
    def DistanceFromBottom(self)->float:
        ...
        ret = GetDllLibDoc().TablePositioning_get_DistanceFromBottom(self.Ptr)
        return ret
    ...
    def DistanceFromBottom(self, value:float):
        ...
        GetDllLibDoc().TablePositioning_set_DistanceFromBottom(self.Ptr, value)
    ...
    def DistanceFromLeft(self)->float:
        ...
        ret = GetDllLibDoc().TablePositioning_get_DistanceFromLeft(self.Ptr)
        return ret
    ...
    def DistanceFromLeft(self, value:float):
        ...
        GetDllLibDoc().TablePositioning_set_DistanceFromLeft(self.Ptr, value)
    ...
    def DistanceFromRight(self)->float:
        ...
        ret = GetDllLibDoc().TablePositioning_get_DistanceFromRight(self.Ptr)
        return ret
    ...
    def DistanceFromRight(self, value:float):
        ...
        GetDllLibDoc().TablePositioning_set_DistanceFromRight(self.Ptr, value)
    ...
    def ClearFormatting(self):
        ...
        GetDllLibDoc().TablePositioning_ClearFormatting(self.Ptr)
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = GetDllLibDoc().TablePositioning_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def Equals(self ,other:'TablePositioning')->bool:
        ...
        ret = GetDllLibDoc().TablePositioning_EqualsO(self.Ptr, intPtrother)
        return ret

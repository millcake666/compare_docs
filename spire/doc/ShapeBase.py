...
class ShapeBase (  ParagraphBase) :
    ...
    def HasImage(self)->bool:
        ...
        ret = GetDllLibDoc().ShapeBase_get_HasImage(self.Ptr)
        return ret
    ...
    def VerticalPosition(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_VerticalPosition(self.Ptr)
        return ret
    ...
    def VerticalPosition(self, value:float):
        ...
        GetDllLibDoc().ShapeBase_set_VerticalPosition(self.Ptr, value)
    ...
    def Right(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_Right(self.Ptr)
        return ret
    ...
    def Bottom(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_Bottom(self.Ptr)
        return ret
    ...
    def Width(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_Width(self.Ptr)
        return ret
    ...
    def Width(self, value:float):
        ...
        GetDllLibDoc().ShapeBase_set_Width(self.Ptr, value)
    ...
    def Height(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_Height(self.Ptr)
        return ret
    ...
    def Height(self, value:float):
        ...
        GetDllLibDoc().ShapeBase_set_Height(self.Ptr, value)
    ...
    def DistanceTop(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_DistanceTop(self.Ptr)
        return ret
    ...
    def DistanceTop(self, value:float):
        ...
        GetDllLibDoc().ShapeBase_set_DistanceTop(self.Ptr, value)
    ...
    def DistanceBottom(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_DistanceBottom(self.Ptr)
        return ret
    ...
    def DistanceBottom(self, value:float):
        ...
        GetDllLibDoc().ShapeBase_set_DistanceBottom(self.Ptr, value)
    ...
    def DistanceLeft(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_DistanceLeft(self.Ptr)
        return ret
    ...
    def DistanceLeft(self, value:float):
        ...
        GetDllLibDoc().ShapeBase_set_DistanceLeft(self.Ptr, value)
    ...
    def DistanceRight(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_DistanceRight(self.Ptr)
        return ret
    ...
    def DistanceRight(self, value:float):
        ...
        GetDllLibDoc().ShapeBase_set_DistanceRight(self.Ptr, value)
    ...
    def Rotation(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:float):
        GetDllLibDoc().ShapeBase_set_Rotation.argtypes=[c_void_p, c_double]
        GetDllLibDoc().ShapeBase_set_Rotation(self.Ptr, value)
    ...
    def ZOrder(self)->int:
        ...
        ret = GetDllLibDoc().ShapeBase_get_ZOrder(self.Ptr)
        return ret

    @ZOrder.setter
    def ZOrder(self, value:int):
        GetDllLibDoc().ShapeBase_set_ZOrder.argtypes=[c_void_p, c_int]
        GetDllLibDoc().ShapeBase_set_ZOrder(self.Ptr, value)
    ...
    def AdjustWithEffects(self ,source:'RectangleF')->'RectangleF':
        ...
        intPtr = GetDllLibDoc().ShapeBase_AdjustWithEffects(self.Ptr, intPtrsource)
    ...
    def ShapeType(self)->'ShapeType':
        ...
        ret = GetDllLibDoc().ShapeBase_get_ShapeType(self.Ptr)
    ...
    def HorizontalOrigin(self)->'HorizontalOrigin':
        ...
        ret = GetDllLibDoc().ShapeBase_get_HorizontalOrigin(self.Ptr)
    ...
    def HorizontalOrigin(self, value:'HorizontalOrigin'):
        ...
        GetDllLibDoc().ShapeBase_set_HorizontalOrigin(self.Ptr, value.value)
    ...
    def VerticalOrigin(self)->'VerticalOrigin':
        ...
        ret = GetDllLibDoc().ShapeBase_get_VerticalOrigin(self.Ptr)
    ...
    def VerticalOrigin(self, value:'VerticalOrigin'):
        ...
        GetDllLibDoc().ShapeBase_set_VerticalOrigin(self.Ptr, value.value)
    ...
    def HorizontalAlignment(self)->'ShapeHorizontalAlignment':
        ...
        ret = GetDllLibDoc().ShapeBase_get_HorizontalAlignment(self.Ptr)
    ...
    def HorizontalAlignment(self, value:'ShapeHorizontalAlignment'):
        ...
        GetDllLibDoc().ShapeBase_set_HorizontalAlignment(self.Ptr, value.value)
    ...
    def VerticalAlignment(self)->'ShapeVerticalAlignment':
        ...
        ret = GetDllLibDoc().ShapeBase_get_VerticalAlignment(self.Ptr)
    ...
    def VerticalAlignment(self, value:'ShapeVerticalAlignment'):
        ...
        GetDllLibDoc().ShapeBase_set_VerticalAlignment(self.Ptr, value.value)
    ...
    def WrapType(self)->'TextWrappingStyle':
        ...
        ret = GetDllLibDoc().ShapeBase_get_WrapType(self.Ptr)
    ...
    def WrapType(self, value:'TextWrappingStyle'):
        ...
        GetDllLibDoc().ShapeBase_set_WrapType(self.Ptr, value.value)
    ...
    def TextWrappingStyle(self)->'TextWrappingStyle':
        ...
        ret = GetDllLibDoc().ShapeBase_get_TextWrappingStyle(self.Ptr)
        objwraped = TextWrappingStyle(ret)
        return objwraped
    ...
    def TextWrappingStyle(self, value:'TextWrappingStyle'):
        ...
        GetDllLibDoc().ShapeBase_set_TextWrappingStyle(self.Ptr, value.value)
    ...
    def TextWrappingType(self)->'TextWrappingType':
        ...
        ret = GetDllLibDoc().ShapeBase_get_TextWrappingType(self.Ptr)
    ...
    def TextWrappingType(self, value:'TextWrappingType'):
        ...
        GetDllLibDoc().ShapeBase_set_TextWrappingType(self.Ptr, value.value)
    ...
    def CoordOrigin(self)->'Point':
        ...
        intPtr = GetDllLibDoc().ShapeBase_get_CoordOrigin(self.Ptr)
    ...
    def CoordOrigin(self, value:'Point'):
        ...
        GetDllLibDoc().ShapeBase_set_CoordOrigin(self.Ptr, value.Ptr)
    ...
    def CoordSize(self)->'Size':
        ...
        intPtr = GetDllLibDoc().ShapeBase_get_CoordSize(self.Ptr)
    ...
    def CoordSize(self, value:'Size'):
        ...
        GetDllLibDoc().ShapeBase_set_CoordSize(self.Ptr, value.Ptr)
    ...
    def IsSignatureLine(self)->bool:
        ...
        ret = GetDllLibDoc().ShapeBase_get_IsSignatureLine(self.Ptr)
        return ret
    ...
    def Size(self)->'SizeF':
        ...
        intPtr = GetDllLibDoc().ShapeBase_get_Size(self.Ptr)
    ...
    def GetDirectShapeAttr(self ,key:int)->'SpireObject':
        ...
        intPtr = GetDllLibDoc().ShapeBase_GetDirectShapeAttr(self.Ptr, key)
    ...
    def FetchInheritedShapeAttr(self ,key:int)->'SpireObject':
        ...
        intPtr = GetDllLibDoc().ShapeBase_FetchInheritedShapeAttr(self.Ptr, key)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def FetchShapeAttr(self ,key:int)->'SpireObject':
        ...
        intPtr = GetDllLibDoc().ShapeBase_FetchShapeAttr(self.Ptr, key)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def SetShapeAttr(self ,key:int,value:'SpireObject'):
        ...
        GetDllLibDoc().ShapeBase_SetShapeAttr(self.Ptr, key,intPtrvalue)
    ...
    def RemoveShapeAttr(self ,key:int):
        ...
        GetDllLibDoc().ShapeBase_RemoveShapeAttr(self.Ptr, key)
    ...
    def GetDirectShapeAttribute(self ,key:int)->'SpireObject':
        ...
        intPtr = GetDllLibDoc().ShapeBase_GetDirectShapeAttribute(self.Ptr, key)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def GetInheritedShapeAttribute(self ,key:int)->'SpireObject':
        ...
        intPtr = GetDllLibDoc().ShapeBase_GetInheritedShapeAttribute(self.Ptr, key)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def GetShapeAttribute(self ,key:int)->'SpireObject':
        ...
        intPtr = GetDllLibDoc().ShapeBase_GetShapeAttribute(self.Ptr, key)
        ret = None if intPtr==None else SpireObject(intPtr)
        return ret
    ...
    def SetShapeAttribute(self ,key:int,value:'SpireObject'):
        ...
        GetDllLibDoc().ShapeBase_SetShapeAttribute(self.Ptr, key,intPtrvalue)
    ...
    def RemoveShapeAttribute(self ,key:int):
        ...
        GetDllLibDoc().ShapeBase_RemoveShapeAttribute(self.Ptr, key)
    ...
    def HasKey(self ,key:int)->bool:
        ...
        ret = GetDllLibDoc().ShapeBase_HasKey(self.Ptr, key)
        return ret
    ...
    def LocalToParent(self ,value:'PointF')->'PointF':
        ...
        intPtr = GetDllLibDoc().ShapeBase_LocalToParent(self.Ptr, intPtrvalue)
    ...
    def SetShapeType(self ,shapeType:'ShapeType'):
        ...
        GetDllLibDoc().ShapeBase_SetShapeType(self.Ptr, enumshapeType)
    ...
    def ChildObjects(self)->'DocumentObjectCollection':
        ...
        intPtr = GetDllLibDoc().ShapeBase_get_ChildObjects(self.Ptr)
    ...
    def AlternativeText(self)->str:
        ...
        ret = PtrToStr(GetDllLibDoc().ShapeBase_get_AlternativeText(self.Ptr))
        return ret
    ...
    def AlternativeText(self, value:str):
        ...
        GetDllLibDoc().ShapeBase_set_AlternativeText(self.Ptr, valuePtr)
    ...
    def HorizontalPosition(self)->float:
        ...
        ret = GetDllLibDoc().ShapeBase_get_HorizontalPosition(self.Ptr)
        return ret
    ...
    def HorizontalPosition(self, value:float):
        ...
        GetDllLibDoc().ShapeBase_set_HorizontalPosition(self.Ptr, value)

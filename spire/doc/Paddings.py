...
class Paddings (  WordAttrCollection) :
    ...
    def Left(self)->float:
        ...
        ret = GetDllLibDoc().Paddings_get_Left(self.Ptr)
        return ret
    ...
    def Left(self, value:float):
        ...
        GetDllLibDoc().Paddings_set_Left(self.Ptr, value)
    ...
    def Top(self)->float:
        ...
        ret = GetDllLibDoc().Paddings_get_Top(self.Ptr)
        return ret
    ...
    def Top(self, value:float):
        ...
        GetDllLibDoc().Paddings_set_Top(self.Ptr, value)
    ...
    def Right(self)->float:
        ...
        ret = GetDllLibDoc().Paddings_get_Right(self.Ptr)
        return ret
    ...
    def Right(self, value:float):
        ...
        GetDllLibDoc().Paddings_set_Right(self.Ptr, value)
    ...
    def Bottom(self)->float:
        ...
        ret = GetDllLibDoc().Paddings_get_Bottom(self.Ptr)
        return ret
    ...
    def Bottom(self, value:float):
        ...
        GetDllLibDoc().Paddings_set_Bottom(self.Ptr, value)
    ...
    def SetAll(self, value:float):
        ...
        GetDllLibDoc().Paddings_set_All(self.Ptr, value)
    ...
    def Equals(self ,obj:SpireObject)->bool:
        ...
        ret = GetDllLibDoc().Paddings_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def Equals(self ,other:'Paddings')->bool:
        ...
        ret = GetDllLibDoc().Paddings_EqualsO(self.Ptr, intPtrother)
        return ret
    ...
    def LeftKey()->int:
        ...
        ret = GetDllLibDoc().Paddings_LeftKey()
        return ret
    ...
    def TopKey()->int:
        ...
        ret = GetDllLibDoc().Paddings_TopKey()
        return ret
    ...
    def BottomKey()->int:
        ...
        ret = GetDllLibDoc().Paddings_BottomKey()
        return ret
    ...
    def RightKey()->int:
        ...
        ret = GetDllLibDoc().Paddings_RightKey()
        return ret

...
class DocumentProperties(SpireObject):
    ...
    def FormFieldShading(self) -> bool:
        ...
        ret = GetDllLibDoc().DocumentProperties_get_FormFieldShading(self.Ptr)
        return ret
    ...
    def FormFieldShading(self, value:bool):
        ...
        GetDllLibDoc().DocumentProperties_set_FormFieldShading(self.Ptr, value)
    ...
    def Version(self) -> 'DocumentVersion':
        ...
        ret = GetDllLibDoc().DocumentProperties_get_Version(self.Ptr)
